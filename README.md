...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-25 05:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/90a8d818-95bd-4be1-938e-b69cfabd538d.git
$ cd 90a8d818-95bd-4be1-938e-b69cfabd538d
```
